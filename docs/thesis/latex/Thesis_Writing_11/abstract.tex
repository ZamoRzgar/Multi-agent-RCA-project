...
and often lack actionable explanations. Large language models (LLMs) offer a promising
...
On Hadoop1, \systemname{} improves coarse macro-\fone{} by 13.3 percentage points over the
...
demonstrating cross-domain generalizability on real industrial logs.
...
producing evidence-grounded explanations. We discuss limitations including label ambiguity,
dataset-specific KG coverage, and computational overhead, and we outline future work
on stronger retrieval strategies and extended deep learning baseline comparisons.
